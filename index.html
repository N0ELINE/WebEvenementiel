...
<body>
    ...
    <div id="violet">
        ...
        <br><br>
        <div class="avis_cli">
            <p id="avis"> <u>Découvrir plus d'avis</u></p>
        </div>
        <br><br>
    </div>
    ...
    <div id="actu">
        ...
        <p class="intro_actu">Split Agency propose une actualité régulière sur les ateliers, les nouvelles formations et
            ...
            aussi
            créatif qu'enrichissant.
        </p>
    </div>
    <!--Image Insta à mettre--> <br><br><br>
    ...
    <div class="footer-basic">
        <footer>
            ...
            <div id="agence">
                <p>
                <h3>Agence</h3><br> <b>A :</b> adresse<br><b>Tél :</b> 00.00.00.00.00<br><b>Email
                    :</b>contact@starevent.fr <br><b>Ouverture :</b> Horraires</p>
            </div>


            <p class="copyright">Star Event © 2021</p>
